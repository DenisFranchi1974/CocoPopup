import {  __experimentalBoxControl as BoxControl, SelectControl, Notice } from '@wordpress/components';
import { __ } from '@wordpress/i18n';
import './editor.scss';

const BorderOptionsPanel = ({ width, setWidth, style, setStyle, radius, setRadius }) => {
...
export default BorderOptionsPanel;